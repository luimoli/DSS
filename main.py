...
if __name__ == '__main__':
    ...
    #valid_file = os.path.join(data_root, 'DUTS/ImageSets/val_id.txt')
    # test_file = os.path.join(data_root, 'CG/id/test_id.txt')
    test_file = os.path.join(data_root, 'CG/id_DUTS/test_id.txt')
    target_path = os.path.join(data_root, 'datasets/DUTS/imgs')
    target_file = os.path.join(data_root, 'datasets/DUTS/ImageSets/train_id.txt')
    ...
    parser.add_argument('--early_stop', type=int, default=48000)# iteration number (#120000)
    parser.add_argument('--iter_save', type=int, default=6000)# save model (#2000)
    parser.add_argument('--epoch', type=int, default=50)#50 #500
    ...
    parser.add_argument('--test_map_fold', type=str, default='./results/test_map')
